...
Exports a Map/Object of "void element" node names as defined by the HTML spec.
...
assert(voidElements.span !== true, '<span> is not a void element');
assert(voidElements.img === true, '<img> is a void element');
```
